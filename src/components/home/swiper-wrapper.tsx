...
const slides = [
  ...
  },
  {
    title: '油缸悬挂系列',
    href: '/yougangxuangua/',
    image: '/renyi/product-category-hydraulic-suspension-cylinders.jpg?v=20260801',
  ...
  },
  {
    title: '专用设备系列',
    href: '/zhuanyongxilie/',
    image: '/renyi/product-category-special-equipment-yard.jpg?v=20260801',
  ...
  },
  {
    title: '选矿设备系列',
    href: '/fuxuanjixilie/',
    image: '/renyi/product-category-mineral-processing-fill.jpg?v=20260801',
  ...
  },
  {
    title: '结构件系列',
    href: '/jiegouxilie/',
    image: '/renyi/product-category-structural-components-fill.jpg?v=20260801',
