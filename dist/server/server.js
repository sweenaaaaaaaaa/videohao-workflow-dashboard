...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-C_bs_J80.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-B6dvPRdX.js").then((n2) => n2.r);
