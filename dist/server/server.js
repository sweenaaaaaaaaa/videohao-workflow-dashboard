...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-rTKbQSFO.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-odDWxw-3.js").then((n2) => n2.r);
